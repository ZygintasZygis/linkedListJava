 ...
 * SUDARYKITE savo klasės objektų generavimo metodą.
 * SUDARYKITE kelių giminingų pagal paskirtį sąrašo metodų efektyvumo tyrimą.
 * SUDARYKITE bent trijų rikiavimo metodų greitaveikos tyrimą.
 * **************************************************************************
 */
...
//    static int[] tiriamiKiekiai = {10_000, 20_000, 40_000, 80_000};
	...
	void paprastasTyrimas(int elementųKiekis) {
		...
		aSeries2.sortJava(Automobilis.pagalKainą);
